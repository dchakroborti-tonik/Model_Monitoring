...
print(f"cic_model_sil model Gini Calculation and Upload Completed!")
...
print(f"alpha_stack_credo_score_sil model Gini Calculation and Upload Completed!")
...
print(f"apps_score_model_sil model Gini Calculation and Upload Completed!")
...
# %% [markdown]
# #### Inserting into the fact and dimension table
...
fact_table, dimension_table = update_tables(
    fact_table,
    dimension_table,
    model_name="alpha_stack_credo_score_cash",
    product="CASH",
)
print(f"The shape of the fact table is:\t {fact_table.shape}")
print(f"The shape of the dimension table is:\t {dimension_table.shape}")
...
fact_table, dimension_table = update_tables(
    fact_table,
    dimension_table,
    model_name="beta_stack_credo_score_cash",
    product="CASH",
)
print(f"The shape of the fact table is:\t {fact_table.shape}")
print(f"The shape of the dimension table is:\t {dimension_table.shape}")
